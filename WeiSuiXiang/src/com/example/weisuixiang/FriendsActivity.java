...
public class FriendsActivity extends Activity {
	...
	private void getfriends() {
		// TODO Auto-generated method stub
		fa.friends(Long.parseLong(id), 100, 0, false, new RequestListener(){

			@Override
			public void onComplete(String arg0) {
				// TODO Auto-generated method stub
				Log.i("sina", arg0);
				new UpDateUI(FriendsActivity.this, this, arg0).start();
			}
	...
	class UpDateUI extends Thread{
		...
		public void run() {
			try{
			    ...
			    ms.setData(bd);
			    ms.what=0;
			    friendsActivity.hd.sendMessage(ms);
			    }catch(Exception e) {
		...
		public UpDateUI(FriendsActivity friendsActivity, RequestListener listener , String arg0){
	...
	class ItemAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = getLayoutInflater().inflate(R.layout.friends_list, parent, false);
				holder = new ViewHolder();
				holder.screen_name = (TextView) view.findViewById(R.id.friends_screen_name);
				holder.profile_image = (ImageView) view.findViewById(R.id.friends_image);
				view.setTag(holder);
			} else {
